...
@section('content')
  <div class="container" id="app">
    <center><h2>Nueva Entrada de Materiales de Limpieza</h2></center>
    <form action="entradasLimpieza" class="form-horizontal" method="get">
        @if(count($errors) > 0)
            <div class="errors">
        ...
        <div class="form-group">
            <div class="col-sm-10">
              <label for="precio">Precio Unitario:</label>
                <input type="text" class="form-control" name="precio" placeholder="Precio del producto..." onkeypress="return valida2(event)" value="{{old('domicilio')}}"  required>
            </div>
        </div>
